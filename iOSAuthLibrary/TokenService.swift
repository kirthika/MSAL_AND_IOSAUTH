...
open class TokenService {
    ...
    func getTokens(_ auth_code: String, completion: @escaping ([String]) -> Void) -> [String]{
        ...
        Alamofire.request("https://login.microsoftonline.com/3ca60f43-0cb5-4822-9ca0-1553fc5382c9/oauth2/v2.0/token?p=B2C_1_SignupAndSignin", method: .post, parameters:
            ["client_id": "ce25c98b-f01d-46ad-936a-62ac28c939e5", "redirect_uri":"urn:ieft:wg:oauth:2.0:oob", "code":auth_code, "grant_type":"authorization_code", "scope":"openid offline_access"]).responseJSON{ response in
